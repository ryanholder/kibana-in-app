/*! kibana - v3.0.0pre-milestone5 - 2013-12-11
...
!function (a, b) {
    ...
    function zc(a, b, c, d, e) {
        ...
        if (!j) {
            ...
            for (t = p; t < o.length; t++)(o.length - t) % q === 0 && 0 !== t && (h += c), h += o.charAt(t);
            for (; n.length < e;)n += "0";
    ...
    var a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F = this, G = F && F.ejs, H = Array.prototype, I = Object.prototype, J = H.slice, K = I.toString, L = I.hasOwnProperty, M = H.forEach, N = Array.isArray, O = H.indexOf, P = {};
    E = "undefined" != typeof exports ? exports : F.ejs = {}, a = function (a, b) {
        return L.call(a, b)
    }, b = function (b, c, d) {
        if (null != b)if (M && b.forEach === M)b.forEach(c, d); else if (b.length === +b.length) {
            for (var e = 0, f = b.length; f > e; e++)if (c.call(d, b[e], e, b) === P)return
        } else for (var g in b)if (a(b, g) && c.call(d, b[g], g, b) === P)return
    }, c = function (a) {
        return b(J.call(arguments, 1), function (b) {
        ...
        var e, f, h = {};
        for (e in b)a(b, e) && -1 === d(c, e) && (f = b[e], g(f) && (f = f.join()), h[e] = f);
        return h
    }, f = function (b, c) {
        var d, f = e(b, c), g = [];
        for (d in f)a(f, d) && g.push(d + "=" + encodeURIComponent(f[d]));
        return g.join("&")
    }, g = N || function (a) {
    ...
    }, k = "function" != typeof/./ ? function (a) {
        return"function" == typeof a
    } : function (a) {
        return"[object Function]" === K.call(a)
    }, l = function (b) {
        return h(b) && a(b, "_type") && a(b, "_self") && a(b, "toString")
    }, m = function (a) {
        return l(a) && "query" === a._type()
    }, n = function (a) {
        return l(a) && "rescore" === a._type()
    }, o = function (a) {
        return l(a) && "filter" === a._type()
    }, p = function (a) {
        return l(a) && "facet" === a._type()
    }, q = function (a) {
        return l(a) && "script field" === a._type()
    }, r = function (a) {
        return l(a) && "geo point" === a._type()
    }, s = function (a) {
        return l(a) && "indexed shape" === a._type()
    }, t = function (a) {
        return l(a) && "shape" === a._type()
    }, u = function (a) {
        return l(a) && "sort" === a._type()
    }, v = function (a) {
        return l(a) && "highlight" === a._type()
    }, w = function (a) {
        return l(a) && "suggest" === a._type()
    }, x = function (a) {
        return l(a) && "generator" === a._type()
    }, y = function (a) {
        return l(a) && "cluster health" === a._type()
    }, z = function (a) {
        return l(a) && "cluster state" === a._type()
    }, A = function (a) {
        return l(a) && "node stats" === a._type()
    }, B = function (a) {
        return l(a) && "node info" === a._type()
    }, C = function (a) {
        return l(a) && "request" === a._type()
    }, D = function (a) {
        return l(a) && "multi search request" === a._type()
    }, E.DateHistogramFacet = function (a) {
        var b = {};
        return b[a] = {date_histogram: {}}, {field: function (c) {
            ...
            if (!o(c))throw new TypeError("Argument must be a Filter");
    ...
    }, E.GeoDistanceFacet = function (a) {
        var b = {}, c = E.GeoPoint([0, 0]), d = "location";
        return b[a] = {geo_distance: {location: c._self(), ranges: []}}, {field: function (c) {
            ...
            if (null == e)return c;
            if (!r(e))throw new TypeError("Argument must be a GeoPoint");
    ...
    }, E.QueryFacet = function (a) {
        var b = {};
        return b[a] = {}, {query: function (c) {
            if (null == c)return b[a].query;
            if (!m(c))throw new TypeError("Argument must be a Query");
            return b[a].query = c._self(), this
        }, facetFilter: function (c) {
            if (null == c)return b[a].facet_filter;
            if (!o(c))throw new TypeError("Argumnet must be a Filter");
            return b[a].facet_filter = c._self(), this
        }, global: function (c) {
            return null == c ? b[a].global : (b[a].global = c, this)
        }, mode: function (c) {
        ...
        return b[a] = {statistical: {}}, {field: function (c) {
            ...
            if (!g(c))throw new TypeError("Argument must be an array");
        ...
        return b[a] = {terms: {}}, {field: function (c) {
            ...
            if (i(c))b[a].terms.exclude.push(c); else {
                if (!g(c))throw new TypeError("Argument must be string or array");
                b[a].terms.exclude = c
            }
            return this
        }, regex: function (c) {
    ...
    }, E.AndFilter = function (a) {
        var b, c, d = {and: {filters: []}};
        if (o(a))d.and.filters.push(a._self()); else {
            if (!g(a))throw new TypeError("Argument must be a Filter or Array of Filters");
            for (b = 0, c = a.length; c > b; b++) {
                if (!o(a[b]))throw new TypeError("Array must contain only Filter objects");
                d.and.filters.push(a[b]._self())
            }
        }
        return{filters: function (a) {
            var b, c;
            if (null == a)return d.and.filters;
            if (o(a))d.and.filters.push(a._self()); else {
                if (!g(a))throw new TypeError("Argument must be a Filter or an Array of Filters");
                for (d.and.filters = [], b = 0, c = a.length; c > b; b++) {
                    if (!o(a[b]))throw new TypeError("Array must contain only Filter objects");
                    d.and.filters.push(a[b]._self())
                }
            }
            ...
            return null == a ? d.and._name : (d.and._name = a, this)
        }, cache: function (a) {
            return null == a ? d.and._cache : (d.and._cache = a, this)
        }, cacheKey: function (a) {
            return null == a ? d.and._cache_key : (d.and._cache_key = a, this)
        }, toString: function () {
    ...
    }, E.BoolFilter = function () {
        var a = {bool: {}};
        return{must: function (b) {
            var c, d;
            if (null == a.bool.must && (a.bool.must = []), null == b)return a.bool.must;
            if (o(b))a.bool.must.push(b._self()); else {
                if (!g(b))throw new TypeError("Argument must be a Filter or array of Filters");
                for (a.bool.must = [], c = 0, d = b.length; d > c; c++) {
                    if (!o(b[c]))throw new TypeError("Argument must be an array of Filters");
            ...
            if (o(b))a.bool.must_not.push(b._self()); else {
                if (!g(b))throw new TypeError("Argument must be a Filter or array of Filters");
                for (a.bool.must_not = [], c = 0, d = b.length; d > c; c++) {
                    if (!o(b[c]))throw new TypeError("Argument must be an array of Filters");
            ...
            if (o(b))a.bool.should.push(b._self()); else {
                if (!g(b))throw new TypeError("Argument must be a Filter or array of Filters");
                for (a.bool.should = [], c = 0, d = b.length; d > c; c++) {
                    if (!o(b[c]))throw new TypeError("Argument must be an array of Filters");
        ...
        return b.geo_bounding_box[a] = {}, {field: function (c) {
            ...
            if (!r(c))throw new TypeError("Argument must be a GeoPoint");
    ...
    }, E.GeoDistanceFilter = function (a) {
        var b = {geo_distance: {}};
        return b.geo_distance[a] = [0, 0], {field: function (c) {
            ...
            if (!j(a))throw new TypeError("Argument must be a numeric value");
    ...
    }, E.GeoDistanceRangeFilter = function (a) {
        ...
        return b.geo_polygon[a] = {points: []}, {field: function (c) {
            ...
            if (r(c))b.geo_polygon[a].points.push(c._self()); else {
                if (!g(c))throw new TypeError("Argument must be a GeoPoint or Array of GeoPoints");
                for (b.geo_polygon[a].points = [], d = 0, e = c.length; e > d; d++) {
                    if (!r(c[d]))throw new TypeError("Argument must be Array of GeoPoints");
                    b.geo_polygon[a].points.push(c[d]._self())
                }
            }
            return this
        }, normalize: function (a) {
    ...
    }, E.HasChildFilter = function (a, b) {
        if (!m(a))throw new TypeError("No Query object found");
        var c = {has_child: {query: a._self(), type: b}};
        return{query: function (a) {
            if (null == a)return c.has_child.query;
            if (!m(a))throw new TypeError("Argument must be a Query object");
            return c.has_child.query = a._self(), this
        }, filter: function (a) {
            if (null == a)return c.has_child.filter;
            if (!o(a))throw new TypeError("Argument must be a Filter object");
            return c.has_child.filter = a._self(), this
        }, type: function (a) {
            return null == a ? c.has_child.type : (c.has_child.type = a, this)
        }, shortCircuitCutoff: function (a) {
            return null == a ? c.has_child.short_circuit_cutoff : (c.has_child.short_circuit_cutoff = a, this)
        }, scope: function () {
            return this
        }, name: function (a) {
            return null == a ? c.has_child._name : (c.has_child._name = a, this)
        }, cache: function (a) {
            return null == a ? c.has_child._cache : (c.has_child._cache = a, this)
        }, cacheKey: function (a) {
            return null == a ? c.has_child._cache_key : (c.has_child._cache_key = a, this)
        }, toString: function () {
    ...
    }, E.HasParentFilter = function (a, b) {
        if (!m(a))throw new TypeError("No Query object found");
        ...
        return{query: function (a) {
            ...
            return null == a ? c.has_parent._cache : (c.has_parent._cache = a, this)
        }, cacheKey: function (a) {
            return null == a ? c.has_parent._cache_key : (c.has_parent._cache_key = a, this)
        }, toString: function () {
            return JSON.stringify(c)
        }, _type: function () {
            return"filter"
    ...
    }, E.IdsFilter = function (a) {
        var b = {ids: {}};
        if (i(a))b.ids.values = [a]; else {
            if (!g(a))throw new TypeError("Argument must be a string or an array");
            b.ids.values = a
        }
        return{values: function (a) {
            if (null == a)return b.ids.values;
            if (i(a))b.ids.values.push(a); else {
                if (!g(a))throw new TypeError("Argument must be a string or an array");
                b.ids.values = a
            }
            return this
    ...
    }, E.IndicesFilter = function (a, b) {
        if (!o(a))throw new TypeError("Argument must be a Filter");
        var c = {indices: {filter: a._self()}};
        if (i(b))c.indices.indices = [b]; else {
            if (!g(b))throw new TypeError("Argument must be a string or array");
            c.indices.indices = b
        }
        return{indices: function (a) {
            if (null == a)return c.indices.indices;
            if (i(a))c.indices.indices.push(a); else {
                if (!g(a))throw new TypeError("Argument must be a string or array");
                c.indices.indices = a
            }
            return this
        }, filter: function (a) {
            ...
            if (i(a))a = a.toLowerCase(), ("none" === a || "all" === a) && (c.indices.no_match_filter = a); else {
                if (!o(a))throw new TypeError("Argument must be string or Filter");
    ...
    }, E.NumericRangeFilter = function (a) {
        var b = {numeric_range: {}};
        return b.numeric_range[a] = {}, {field: function (c) {
            ...
            if (!j(c))throw new TypeError("Argument must be a numeric value");
    ...
    }, E.OrFilter = function (a) {
        var b, c, d;
        if (b = {or: {filters: []}}, o(a))b.or.filters.push(a._self()); else {
            if (!g(a))throw new TypeError("Argument must be a Filter or array of Filters");
            for (c = 0, d = a.length; d > c; c++) {
                if (!o(a[c]))throw new TypeError("Argument must be array of Filters");
        ...
        return{filters: function (a) {
            ...
            if (o(a))b.or.filters.push(a._self()); else {
                if (!g(a))throw new TypeError("Argument must be a Filter or array of Filters");
                for (b.or.filters = [], c = 0, d = a.length; d > c; c++) {
                    if (!o(a[c]))throw new TypeError("Argument must be an array of Filters");
                    b.or.filters.push(a[c]._self())
                }
            }
            return this
    ...
    }, E.QueryFilter = function (a) {
        if (!m(a))throw new TypeError("Argument must be a Query");
    ...
    }, E.TermsFilter = function (a, b) {
        var c = {terms: {}}, d = function () {
            g(c.terms[a]) || (c.terms[a] = [])
        }, e = function () {
            g(c.terms[a]) && (c.terms[a] = {})
        };
        return c.terms[a] = g(b) ? b : [b], {field: function (b) {
            var d = c.terms[a];
            return null == b ? a : (delete c.terms[a], a = b, c.terms[b] = d, this)
        }, terms: function (b) {
            return d(), null == b ? c.terms[a] : (g(b) ? c.terms[a] = b : c.terms[a].push(b), this)
        }, index: function (b) {
            return e(), null == b ? c.terms[a].index : (c.terms[a].index = b, this)
        }, type: function (b) {
            return e(), null == b ? c.terms[a].type : (c.terms[a].type = b, this)
        }, id: function (b) {
            return e(), null == b ? c.terms[a].id : (c.terms[a].id = b, this)
        }, path: function (b) {
            return e(), null == b ? c.terms[a].path : (c.terms[a].path = b, this)
        }, routing: function (b) {
            return e(), null == b ? c.terms[a].routing : (c.terms[a].routing = b, this)
        }, cacheLookup: function (b) {
            return e(), null == b ? c.terms[a].cache : (c.terms[a].cache = b, this)
    ...
    }, E.Document = function (a, b, c) {
        var d = {}, j = ["upsert", "source", "script", "lang", "params"];
        return{index: function (b) {
            return null == b ? a : (a = b, this)
        }, type: function (a) {
            return null == a ? b : (b = a, this)
        }, id: function (a) {
            return null == a ? c : (c = a, this)
        }, routing: function (a) {
            return null == a ? d.routing : (d.routing = a, this)
        }, parent: function (a) {
            return null == a ? d.parent : (d.parent = a, this)
        }, timestamp: function (a) {
            return null == a ? d.timestamp : (d.timestamp = a, this)
        }, ttl: function (a) {
            return null == a ? d.ttl : (d.ttl = a, this)
        }, timeout: function (a) {
            return null == a ? d.timeout : (d.timeout = a, this)
        }, refresh: function (a) {
            return null == a ? d.refresh : (d.refresh = a, this)
        }, version: function (a) {
            return null == a ? d.version : (d.version = a, this)
        }, versionType: function (a) {
            return null == a ? d.version_type : (a = a.toLowerCase(), ("internal" === a || "external" === a) && (d.version_type = a), this)
        }, opType: function (a) {
            return null == a ? d.op_type : (a = a.toLowerCase(), ("index" === a || "create" === a) && (d.op_type = a), this)
        }, replication: function (a) {
            return null == a ? d.replication : (a = a.toLowerCase(), ("async" === a || "sync" === a || "default" === a) && (d.replication = a), this)
        }, consistency: function (a) {
            return null == a ? d.consistency : (a = a.toLowerCase(), ("default" === a || "one" === a || "quorum" === a || "all" === a) && (d.consistency = a), this)
        }, preference: function (a) {
            return null == a ? d.preference : (d.preference = a, this)
        }, realtime: function (a) {
            return null == a ? d.realtime : (d.realtime = a, this)
        }, fields: function (a) {
            if (null == d.fields && (d.fields = []), null == a)return d.fields;
            if (i(a))d.fields.push(a); else {
                if (!g(a))throw new TypeError("Argument must be string or array");
                d.fields = a
            }
            return this
        }, script: function (a) {
            return null == a ? d.script : (d.script = a, this)
        }, lang: function (a) {
            return null == a ? d.lang : (d.lang = a, this)
        }, params: function (a) {
            if (null == a)return d.params;
            if (!h(a))throw new TypeError("Argument must be an object");
            return d.params = a, this
        }, retryOnConflict: function (a) {
            return null == a ? d.retry_on_conflict : (d.retry_on_conflict = a, this)
        }, upsert: function (a) {
            if (null == a)return d.upsert;
            if (!h(a))throw new TypeError("Argument must be an object");
            return d.upsert = a, this
        }, docAsUpsert: function (a) {
            return null == a ? d.doc_as_upsert : (d.doc_as_upsert = a, this)
        }, source: function (a) {
            if (null == a)return d.source;
            if (!h(a))throw new TypeError("Argument must be an object");
            return d.source = a, this
        }, toString: function () {
            return JSON.stringify(d)
        }, _type: function () {
            return"document"
            ...
            if (null == E.client)throw new Error("No Client Set");
            if (null == a || null == b || null == c)throw new Error("Index, Type, and ID must be set");
            var h = "/" + a + "/" + b + "/" + c;
            return E.client.get(h, e(d, j), f, g)
        }, doIndex: function (e, g) {
            if (null == E.client)throw new Error("No Client Set");
            if (null == a || null == b)throw new Error("Index and Type must be set");
            if (null == d.source)throw new Error("No source document found");
            var h, i = "/" + a + "/" + b, k = JSON.stringify(d.source), l = f(d, j);
            return null != c && (i = i + "/" + c), "" !== l && (i = i + "?" + l), h = null == c ? E.client.post(i, k, e, g) : E.client.put(i, k, e, g)
        }, doUpdate: function (e, g) {
            if (null == E.client)throw new Error("No Client Set");
            if (null == a || null == b || null == c)throw new Error("Index, Type, and ID must be set");
            if (null == d.script && null == d.source)throw new Error("Update script or document required");
            var h = "/" + a + "/" + b + "/" + c + "/_update", i = {}, k = f(d, j);
            return"" !== k && (h = h + "?" + k), null != d.script && (i.script = d.script), null != d.lang && (i.lang = d.lang), null != d.params && (i.params = d.params), null != d.upsert && (i.upsert = d.upsert), null != d.source && (i.doc = d.source), E.client.post(h, JSON.stringify(i), e, g)
        }, doDelete: function (e, g) {
            if (null == E.client)throw new Error("No Client Set");
            if (null == a || null == b || null == c)throw new Error("Index, Type, and ID must be set");
            var h = "/" + a + "/" + b + "/" + c, i = "", k = f(d, j);
            return"" !== k && (h = h + "?" + k), E.client.del(h, i, e, g)
        }}
    }, E.BoolQuery = function () {
        var a = {bool: {}};
        return{must: function (b) {
            var c, d;
            if (null == a.bool.must && (a.bool.must = []), null == b)return a.bool.must;
            if (m(b))a.bool.must.push(b._self()); else {
                if (!g(b))throw new TypeError("Argument must be a Query or array of Queries");
                for (a.bool.must = [], c = 0, d = b.length; d > c; c++) {
                    if (!m(b[c]))throw new TypeError("Argument must be an array of Queries");
                    a.bool.must.push(b[c]._self())
                }
            }
            return this
            ...
            var c, d;
            if (null == a.bool.must_not && (a.bool.must_not = []), null == b)return a.bool.must_not;
            if (m(b))a.bool.must_not.push(b._self()); else {
                if (!g(b))throw new TypeError("Argument must be a Query or array of Queries");
                for (a.bool.must_not = [], c = 0, d = b.length; d > c; c++) {
                    if (!m(b[c]))throw new TypeError("Argument must be an array of Queries");
                    a.bool.must_not.push(b[c]._self())
            ...
            var c, d;
            if (null == a.bool.should && (a.bool.should = []), null == b)return a.bool.should;
            if (m(b))a.bool.should.push(b._self()); else {
                if (!g(b))throw new TypeError("Argument must be a Query or array of Queries");
                for (a.bool.should = [], c = 0, d = b.length; d > c; c++) {
                    if (!m(b[c]))throw new TypeError("Argument must be an array of Queries");
                    a.bool.should.push(b[c]._self())
        ...
        }, adjustPureNegative: function (b) {
            return null == b ? a.bool.adjust_pure_negative : (a.bool.adjust_pure_negative = b, this)
    ...
    }, E.BoostingQuery = function (a, b, c) {
        if (!m(a) || !m(b))throw new TypeError("Arguments must be Queries");
    ...
    }, E.CommonTermsQuery = function (a, b) {
        var c = {common: {}};
        return null == a && (a = "no_field_set"), c.common[a] = {}, null != b && (c.common[a].query = b), {field: function (b) {
            ...
            return null == b ? c.common[a].disable_coord : (c.common[a].disable_coord = b, this)
            ...
            return null == b ? c.common[a].minimum_should_match.low_freq : (null == c.common[a].minimum_should_match && (c.common[a].minimum_should_match = {}), c.common[a].minimum_should_match.low_freq = b, this)
        }, minimumShouldMatchLowFreq: function (a) {
            return this.minimumShouldMatch(a)
        }, minimumShouldMatchHighFreq: function (b) {
            return null == b ? c.common[a].minimum_should_match.high_freq : (null == c.common[a].minimum_should_match && (c.common[a].minimum_should_match = {}), c.common[a].minimum_should_match.high_freq = b, this)
        }, boost: function (b) {
    ...
    }, E.CustomBoostFactorQuery = function (a) {
        if (!m(a))throw new TypeError("Argument must be a Query");
    ...
    }, E.CustomFiltersScoreQuery = function (a, c) {
        if (!m(a))throw new TypeError("Argument must be a Query");
        var d = {custom_filters_score: {query: a._self(), filters: []}}, e = function (a) {
            var b = null;
            return a.filter && o(a.filter) && (b = {filter: a.filter._self()}, a.boost ? b.boost = a.boost : a.script ? b.script = a.script : b = null), b
        };
        return b(g(c) ? c : [c], function (a) {
            var b = e(a);
            null !== b && d.custom_filters_score.filters.push(b)
        }), {query: function (a) {
            if (null == a)return d.custom_filters_score.query;
            if (!m(a))throw new TypeError("Argument must be a Query");
            return d.custom_filters_score.query = a._self(), this
        }, filters: function (a) {
            return null == a ? d.custom_filters_score.filters : (g(a) && (d.custom_filters_score.filters = []), b(g(a) ? a : [a], function (a) {
                var b = e(a);
                null !== b && d.custom_filters_score.filters.push(b)
            }), this)
        }, scoreMode: function (a) {
            return null == a ? d.custom_filters_score.score_mode : (a = a.toLowerCase(), ("first" === a || "min" === a || "max" === a || "total" === a || "avg" === a || "multiply" === a) && (d.custom_filters_score.score_mode = a), this)
        }, params: function (a) {
            return null == a ? d.custom_filters_score.params : (d.custom_filters_score.params = a, this)
        }, lang: function (a) {
            return null == a ? d.custom_filters_score.lang : (d.custom_filters_score.lang = a, this)
        }, maxBoost: function (a) {
            return null == a ? d.custom_filters_score.max_boost : (d.custom_filters_score.max_boost = a, this)
        }, boost: function (a) {
            return null == a ? d.custom_filters_score.boost : (d.custom_filters_score.boost = a, this)
        }, toString: function () {
            return JSON.stringify(d)
        }, _type: function () {
            return"query"
    ...
    }, E.CustomScoreQuery = function (a, b) {
        if (!m(a) && !o(a))throw new TypeError("Argument must be a Query or Filter");
        var c = {custom_score: {script: b}};
        return m(a) ? c.custom_score.query = a._self() : o(a) && (c.custom_score.filter = a._self()), {query: function (a) {
            if (null == a)return c.custom_score.query;
            if (!m(a))throw new TypeError("Argument must be a Query");
            return c.custom_score.query = a._self(), this
        }, filter: function (a) {
            if (null == a)return c.custom_score.filter;
            if (!o(a))throw new TypeError("Argument must be a Filter");
            return c.custom_score.filter = a._self(), this
        }, script: function (a) {
    ...
    }, E.DisMaxQuery = function () {
        var a = {dis_max: {}};
        return{queries: function (b) {
            var c, d;
            if (null == b)return a.dis_max.queries;
            if (null == a.dis_max.queries && (a.dis_max.queries = []), m(b))a.dis_max.queries.push(b._self()); else {
                if (!g(b))throw new TypeError("Argument must be a Query or array of Queries");
                for (a.dis_max.queries = [], c = 0, d = b.length; d > c; c++) {
                    if (!m(b[c]))throw new TypeError("Argument must be array of Queries");
    ...
    }, E.FieldMaskingSpanQuery = function (a, b) {
        if (!m(a))throw new TypeError("Argument must be a SpanQuery");
    ...
    }, E.FilteredQuery = function (a, b) {
        if (!m(a))throw new TypeError("Argument must be a Query");
        if (null != b && !o(b))throw new TypeError("Argument must be a Filter");
    ...
    }, E.FuzzyLikeThisFieldQuery = function (a, b) {
        var c = {flt_field: {}};
        ...
        }, failOnUnsupportedField: function (b) {
            return null == b ? c.flt_field[a].fail_on_unsupported_field : (c.flt_field[a].fail_on_unsupported_field = b, this)
        }, boost: function (b) {
        ...
        }, failOnUnsupportedField: function (a) {
            return null == a ? b.flt.fail_on_unsupported_field : (b.flt.fail_on_unsupported_field = a, this)
        }, boost: function (a) {
    ...
    }, E.HasChildQuery = function (a, b) {
        if (!m(a))throw new TypeError("Argument must be a valid Query");
        var c = {has_child: {query: a._self(), type: b}};
        return{query: function (a) {
            if (null == a)return c.has_child.query;
            if (!m(a))throw new TypeError("Argument must be a valid Query");
            ...
            return null == a ? c.has_child.score_mode : (a = a.toLowerCase(), ("none" === a || "max" === a || "sum" === a || "avg" === a) && (c.has_child.score_mode = a), this)
        }, shortCircuitCutoff: function (a) {
            return null == a ? c.has_child.short_circuit_cutoff : (c.has_child.short_circuit_cutoff = a, this)
        }, boost: function (a) {
        ...
        return{query: function (a) {
            ...
            return null == a ? c.has_parent.score_mode : (a = a.toLowerCase(), ("none" === a || "score" === a) && (c.has_parent.score_mode = a), this)
        }, boost: function (a) {
        ...
        return{indices: function (a) {
            ...
            if (i(a))a = a.toLowerCase(), ("none" === a || "all" === a) && (c.indices.no_match_query = a); else {
                if (!m(a))throw new TypeError("Argument must be string or Query");
    ...
    }, E.MoreLikeThisFieldQuery = function (a, b) {
        var c = {mlt_field: {}};
        return c.mlt_field[a] = {like_text: b}, {field: function (b) {
            ...
            return null == b ? c.mlt_field[a].fail_on_unsupported_field : (c.mlt_field[a].fail_on_unsupported_field = b, this)
        }, boost: function (b) {
    ...
    }, E.MoreLikeThisQuery = function (a, b) {
        var c = {mlt: {like_text: b, fields: []}};
        if (i(a))c.mlt.fields.push(a); else {
            if (!g(a))throw new TypeError("Argument must be string or array");
            c.mlt.fields = a
        }
        return{fields: function (a) {
            ...
            return null == a ? c.mlt.fail_on_unsupported_field : (c.mlt.fail_on_unsupported_field = a, this)
        }, boost: function (a) {
    ...
    }, E.MultiMatchQuery = function (a, b) {
        var c = {multi_match: {query: b, fields: []}};
        if (i(a))c.multi_match.fields.push(a); else {
            if (!g(a))throw new TypeError("Argument must be string or array");
        ...
        return{path: function (a) {
            ...
            return null == a ? b.nested.score_mode : (a = a.toLowerCase(), ("avg" === a || "total" === a || "max" === a || "none" === a || "sum" === a) && (b.nested.score_mode = a), this)
        }, scope: function () {
            return this
        }, boost: function (a) {
            return null == a ? b.nested.boost : (b.nested.boost = a, this)
        ...
        return b.query_string.query = a, {query: function (a) {
            ...
            if (i(a))b.query_string.fields.push(a); else {
                if (!g(a))throw new TypeError("Argument must be a string or array");
    ...
    }, E.SpanMultiTermQuery = function (a) {
        if (null != a && !m(a))throw new TypeError("Argument must be a MultiTermQuery");
        var b = {span_multi: {match: {}}};
        return null != a && (b.span_multi.match = a._self()), {match: function (a) {
            if (null == a)return b.span_multi.match;
            if (!m(a))throw new TypeError("Argument must be a MultiTermQuery");
            return b.span_multi.match = a._self(), this
        }, toString: function () {
            return JSON.stringify(b)
        }, _type: function () {
            return"query"
    ...
    }, E.SpanNearQuery = function (a, b) {
        var c, d, e = {span_near: {clauses: [], slop: b}};
        if (m(a))e.span_near.clauses.push(a._self()); else {
            if (!g(a))throw new TypeError("Argument must be SpanQuery or array of SpanQueries");
            for (c = 0, d = a.length; d > c; c++) {
                if (!m(a[c]))throw new TypeError("Argument must be array of SpanQueries");
                e.span_near.clauses.push(a[c]._self())
            }
        }
        return{clauses: function (a) {
            var b, c;
            if (null == a)return e.span_near.clauses;
            if (m(a))e.span_near.clauses.push(a._self()); else {
                if (!g(a))throw new TypeError("Argument must be SpanQuery or array of SpanQueries");
                for (e.span_near.clauses = [], b = 0, c = a.length; c > b; b++) {
                    if (!m(a[b]))throw new TypeError("Argument must be array of SpanQueries");
                    e.span_near.clauses.push(a[b]._self())
                }
            }
            return this
        }, slop: function (a) {
            return null == a ? e.span_near.slop : (e.span_near.slop = a, this)
        }, inOrder: function (a) {
            return null == a ? e.span_near.in_order : (e.span_near.in_order = a, this)
        }, collectPayloads: function (a) {
            return null == a ? e.span_near.collect_payloads : (e.span_near.collect_payloads = a, this)
        }, boost: function (a) {
            return null == a ? e.span_near.boost : (e.span_near.boost = a, this)
        }, toString: function () {
    ...
    }, E.SpanNotQuery = function (a, b) {
        if (!m(a) || !m(b))throw new TypeError("Argument must be a SpanQuery");
    ...
    }, E.SpanOrQuery = function (a) {
        var b, c, d = {span_or: {clauses: []}};
        if (m(a))d.span_or.clauses.push(a._self()); else {
            if (!g(a))throw new TypeError("Argument must be SpanQuery or array of SpanQueries");
            for (b = 0, c = a.length; c > b; b++) {
                if (!m(a[b]))throw new TypeError("Argument must be array of SpanQueries");
                d.span_or.clauses.push(a[b]._self())
            }
        }
        return{clauses: function (a) {
            var b, c;
            if (null == a)return d.span_or.clauses;
            if (m(a))d.span_or.clauses.push(a._self()); else {
                if (!g(a))throw new TypeError("Argument must be SpanQuery or array of SpanQueries");
                for (d.span_or.clauses = [], b = 0, c = a.length; c > b; b++) {
                    if (!m(a[b]))throw new TypeError("Argument must be array of SpanQueries");
                    d.span_or.clauses.push(a[b]._self())
                }
            }
            ...
            return null == a ? d.span_or.boost : (d.span_or.boost = a, this)
        }, toString: function () {
            return JSON.stringify(d)
        }, _type: function () {
            return"query"
    ...
    }, E.TermsQuery = function (a, b) {
        var c = {terms: {}};
        if (i(b))c.terms[a] = [b]; else {
            if (!g(b))throw new TypeError("Argument must be string or array");
            c.terms[a] = b
        }
    ...
    }, E.TopChildrenQuery = function (a, b) {
        if (!m(a))throw new TypeError("Argument must be a Query");
        ...
        return{query: function (a) {
            ...
            return null == a ? c.top_children.score : (a = a.toLowerCase(), ("max" === a || "sum" === a || "avg" === a || "total" === a) && (c.top_children.score = a), this)
        }, scoreMode: function (a) {
            return null == a ? c.top_children.score_mode : (a = a.toLowerCase(), ("max" === a || "sum" === a || "avg" === a || "total" === a) && (c.top_children.score_mode = a), this)
        }, factor: function (a) {
    ...
    }, E.ClusterHealth = function () {
        var a = {}, b = ["indices"];
        return{indices: function (b) {
            if (null == a.indices && (a.indices = []), null == b)return a.indices;
            if (i(b))a.indices.push(b); else {
                if (!g(b))throw new TypeError("Argument must be string or array");
                a.indices = b
            }
            return this
        }, local: function (b) {
            return null == b ? a.local : (a.local = b, this)
        }, masterTimeout: function (b) {
            return null == b ? a.master_timeout : (a.master_timeout = b, this)
        }, timeout: function (b) {
            return null == b ? a.timeout : (a.timeout = b, this)
        }, waitForStatus: function (b) {
            return null == b ? a.wait_for_status : (b = b.toLowerCase(), ("green" === b || "yellow" === b || "red" === b) && (a.wait_for_status = b), this)
        }, waitForRelocatingShards: function (b) {
            return null == b ? a.wait_for_relocating_shards : (a.wait_for_relocating_shards = b, this)
        }, waitForActiveShards: function (b) {
            return null == b ? a.wait_for_active_shards : (a.wait_for_active_shards = b, this)
        }, waitForNodes: function (b) {
            return null == b ? a.wait_for_nodes : (a.wait_for_nodes = b, this)
        }, level: function (b) {
            return null == b ? a.level : (b = b.toLowerCase(), ("cluster" === b || "indices" === b || "shards" === b) && (a.level = b), this)
        }, toString: function () {
            return JSON.stringify(a)
        }, _type: function () {
            ...
            return a
        }, doHealth: function (c, d) {
            if (null == E.client)throw new Error("No Client Set");
            var f = "/_cluster/health";
            return a.indices && a.indices.length > 0 && (f = f + "/" + a.indices.join()), E.client.get(f, e(a, b), c, d)
        }}
    }, E.ClusterState = function () {
        var a = {}, b = [];
        return{local: function (b) {
            return null == b ? a.local : (a.local = b, this)
        }, masterTimeout: function (b) {
            return null == b ? a.master_timeout : (a.master_timeout = b, this)
        }, filterNodes: function (b) {
            return null == b ? a.filter_nodes : (a.filter_nodes = b, this)
        }, filterRoutingTable: function (b) {
            return null == b ? a.filter_routing_table : (a.filter_routing_table = b, this)
        }, filterMetadata: function (b) {
            return null == b ? a.filter_metadata : (a.filter_metadata = b, this)
        }, filterBlocks: function (b) {
            return null == b ? a.filter_blocks : (a.filter_blocks = b, this)
        }, filterIndices: function (b) {
            if (null == a.filter_indices && (a.filter_indices = []), null == b)return a.filter_indices;
            if (i(b))a.filter_indices.push(b); else {
                if (!g(b))throw new TypeError("Argument must be string or array");
                a.filter_indices = b
            }
            return this
        }, filterIndexTemplates: function (b) {
            if (null == a.filter_index_templates && (a.filter_index_templates = []), null == b)return a.filter_index_templates;
            if (i(b))a.filter_index_templates.push(b); else {
                if (!g(b))throw new TypeError("Argument must be string or array");
                a.filter_index_templates = b
            }
            return this
        }, toString: function () {
            return JSON.stringify(a)
            ...
            return a
        }, doState: function (c, d) {
            if (null == E.client)throw new Error("No Client Set");
            var f = "/_cluster/state";
            return E.client.get(f, e(a, b), c, d)
        }}
    }, E.NodeInfo = function () {
        var a = {}, b = ["nodes"];
        return{nodes: function (b) {
            if (null == a.nodes && (a.nodes = []), null == b)return a.nodes;
            if (i(b))a.nodes.push(b); else {
                if (!g(b))throw new TypeError("Argument must be string or array");
                a.nodes = b
            }
            return this
        }, clear: function (b) {
            return null == b ? a.clear : (a.clear = b, this)
        }, all: function (b) {
            return null == b ? a.all : (a.all = b, this)
        }, settings: function (b) {
            return null == b ? a.settings : (a.settings = b, this)
        }, os: function (b) {
            return null == b ? a.os : (a.os = b, this)
        }, process: function (b) {
            return null == b ? a.process : (a.process = b, this)
        }, jvm: function (b) {
            return null == b ? a.jvm : (a.jvm = b, this)
        }, threadPool: function (b) {
            return null == b ? a.thread_pool : (a.thread_pool = b, this)
        }, network: function (b) {
            return null == b ? a.network : (a.network = b, this)
        }, transport: function (b) {
            return null == b ? a.transport : (a.transport = b, this)
        }, http: function (b) {
            return null == b ? a.http : (a.http = b, this)
        }, plugin: function (b) {
            return null == b ? a.plugin : (a.plugin = b, this)
        }, timeout: function (b) {
            return null == b ? a.timeout : (a.timeout = b, this)
        }, toString: function () {
            return JSON.stringify(a)
            ...
            if (null == E.client)throw new Error("No Client Set");
            var f = "/_nodes";
            return a.nodes && a.nodes.length > 0 && (f = f + "/" + a.nodes.join()), E.client.get(f, e(a, b), c, d)
        }}
    }, E.NodeStats = function () {
        var a = {}, b = ["nodes"];
        return{nodes: function (b) {
            if (null == a.nodes && (a.nodes = []), null == b)return a.nodes;
            if (i(b))a.nodes.push(b); else {
            ...
            return null == b ? a.indices : (a.indices = b, this)
        }, os: function (b) {
            return null == b ? a.os : (a.os = b, this)
        }, process: function (b) {
            return null == b ? a.process : (a.process = b, this)
            ...
            return null == b ? a.fs : (a.fs = b, this)
        }, transport: function (b) {
            return null == b ? a.transport : (a.transport = b, this)
        }, http: function (b) {
            return null == b ? a.http : (a.http = b, this)
            ...
            return a
        }, doStats: function (c, d) {
            if (null == E.client)throw new Error("No Client Set");
            var f = "/_nodes";
            return a.nodes && a.nodes.length > 0 && (f = f + "/" + a.nodes.join()), f += "/stats", E.client.get(f, e(a, b), c, d)
        }}
    }, E.GeoPoint = function (b) {
        var c = [0, 0];
        return null != b && g(b) && 2 === b.length && (c = [b[1], b[0]]), {properties: function (b) {
            return null == b ? c : (h(b) && a(b, "lat") && a(b, "lon") ? c = {lat: b.lat, lon: b.lon} : h(b) && a(b, "geohash") && (c = {geohash: b.geohash}), this)
        }, string: function (a) {
            return null == a ? c : (i(a) && -1 !== a.indexOf(",") && (c = a), this)
        }, geohash: function (a, b) {
            return b = null != b && j(b) ? b : 12, null == a ? c : (i(a) && a.length === b && (c = a), this)
        }, array: function (a) {
            return null == a ? c : (g(a) && 2 === a.length && (c = [a[1], a[0]]), this)
        }, toString: function () {
            return JSON.stringify(c)
        }, _type: function () {
            return"geo point"
    ...
    }, E.Highlight = function (c) {
        var d = {fields: {}}, e = function (b, c, e) {
            null == b ? d[c] = e : (a(d.fields, b) || (d.fields[b] = {}), d.fields[b][c] = e)
        };
        return null != c && (i(c) ? d.fields[c] = {} : g(c) && b(c, function (a) {
            d.fields[a] = {}
        })), {fields: function (c) {
            return null == c ? d.fields : (i(c) ? a(d.fields, c) || (d.fields[c] = {}) : g(c) && b(c, function (b) {
                a(d.fields, b) || (d.fields[b] = {})
            }), void 0)
        }, preTags: function (a, b) {
            return null === a && null != b ? d.fields[b].pre_tags : null == a ? d.pre_tags : (i(a) ? e(b, "pre_tags", [a]) : g(a) && e(b, "pre_tags", a), this)
        }, postTags: function (a, b) {
            return null === a && null != b ? d.fields[b].post_tags : null == a ? d.post_tags : (i(a) ? e(b, "post_tags", [a]) : g(a) && e(b, "post_tags", a), this)
        }, order: function (a, b) {
            return null === a && null != b ? d.fields[b].order : null == a ? d.order : (a = a.toLowerCase(), "score" === a && e(b, "order", a), this)
        }, tagsSchema: function (a) {
            return null == a ? d.tags_schema : (a = a.toLowerCase(), "styled" === a && (d.tags_schema = a), this)
        }, highlightFilter: function (a, b) {
            return null === a && null != b ? d.fields[b].highlight_filter : null == a ? d.highlight_filter : (e(b, "highlight_filter", a), this)
        }, fragmentSize: function (a, b) {
            return null === a && null != b ? d.fields[b].fragment_size : null == a ? d.fragment_size : (e(b, "fragment_size", a), this)
        }, numberOfFragments: function (a, b) {
            return null === a && null != b ? d.fields[b].number_of_fragments : null == a ? d.number_of_fragments : (e(b, "number_of_fragments", a), this)
        }, encoder: function (a) {
            return null == a ? d.encoder : (a = a.toLowerCase(), ("default" === a || "html" === a) && (d.encoder = a), this)
        }, requireFieldMatch: function (a, b) {
            return null === a && null != b ? d.fields[b].require_field_match : null == a ? d.require_field_match : (e(b, "require_field_match", a), this)
        }, boundaryMaxScan: function (a, b) {
            return null === a && null != b ? d.fields[b].boundary_max_scan : null == a ? d.boundary_max_scan : (e(b, "boundary_max_scan", a), this)
        }, boundaryChars: function (a, b) {
            return null === a && null != b ? d.fields[b].boundary_chars : null == a ? d.boundary_chars : (e(b, "boundary_chars", a), this)
        }, type: function (a, b) {
            return null === a && null != b ? d.fields[b].type : null == a ? d.type : (a = a.toLowerCase(), ("fast-vector-highlighter" === a || "highlighter" === a) && e(b, "type", a), this)
        }, fragmenter: function (a, b) {
            return null === a && null != b ? d.fields[b].fragmenter : null == a ? d.fragmenter : (a = a.toLowerCase(), ("simple" === a || "span" === a) && e(b, "fragmenter", a), this)
        }, options: function (a, b) {
            if (null === a && null != b)return d.fields[b].options;
            if (null == a)return d.options;
            if (!h(a) || g(a) || l(a))throw new TypeError("Parameter must be an object");
            return e(b, "options", a), this
        }, toString: function () {
            return JSON.stringify(d)
        }, _type: function () {
            return"highlight"
    ...
    }, E.MultiSearchRequest = function (b) {
        var c, d, e, f = {}, h = function () {
            var b = "", c = [];
            d.length > 0 && (b = b + "/" + d.join()), e.length > 0 && (b = b + "/" + e.join()), b += "/_msearch";
            for (var g in f)a(f, g) && "" !== f[g] && c.push(g + "=" + encodeURIComponent(f[g]));
            return c.length > 0 && (b = b + "?" + c.join("&")), b
        };
        return c = [], b = b || {}, d = null == b.indices ? [] : i(b.indices) ? [b.indices] : b.indices, e = null == b.types ? [] : i(b.types) ? [b.types] : b.types, 0 === d.length && e.length > 0 && (d = ["_all"]), {requests: function (a) {
            if (null == a)return c;
            if (C(a))c.push(a); else {
                if (!g(a))throw new TypeError("Argument must be request or array");
                c = a
            }
            return this
        }, searchType: function (a) {
            return null == a ? f.search_type : (a = a.toLowerCase(), ("dfs_query_then_fetch" === a || "dfs_query_and_fetch" === a || "query_then_fetch" === a || "query_and_fetch" === a || "scan" === a || "count" === a) && (f.search_type = a), this)
        }, indices: function (a) {
            if (null == a)return d;
            if (i(a))d = [a]; else {
                if (!g(a))throw new TypeError("Argument must be a string or array");
            ...
            return 0 === d.length && e.length > 0 && (d = ["_all"]), this
        }, types: function (a) {
            if (null == a)return e;
            if (i(a))e = [a]; else {
                if (!g(a))throw new TypeError("Argument must be a string or array");
            ...
            return null == a ? f.ignore_indices : (a = a.toLowerCase(), ("none" === a || "missing" === a) && (f.ignore_indices = a), this)
        }, toString: function () {
            var a, b, d = [];
            for (a = 0, b = c.length; b > a; a++)d.push(c[a]._self());
            return JSON.stringify(d)
        }, _type: function () {
            ...
            return E.client.post(h(), j, a, b)
        }}
    }, E.Request = function (b) {
        var d, e, f, h = {}, j = function (b) {
            var c = "", d = [];
            e.length > 0 && (c = c + "/" + e.join()), f.length > 0 && (c = c + "/" + f.join()), b.length > 0 && "/" !== b[0] && (c += "/"), c += b;
            for (var g in h)a(h, g) && "" !== h[g] && d.push(g + "=" + encodeURIComponent(h[g]));
            return d.length > 0 && (c = c + "?" + d.join("&")), c
        };
        return d = {}, b = b || {}, e = null == b.indices ? [] : i(b.indices) ? [b.indices] : b.indices, f = null == b.types ? [] : i(b.types) ? [b.types] : b.types, 0 === e.length && f.length > 0 && (e = ["_all"]), null != b.routing && (h.routing = b.routing), {sort: function () {
            var b, c;
            if (a(d, "sort") || (d.sort = []), 0 === arguments.length)return d.sort;
            if (1 === arguments.length) {
                var e = arguments[0];
                if (i(e))d.sort.push(e); else if (u(e))d.sort.push(e._self()); else {
                    if (!g(e))throw new TypeError("Argument must be string, Sort, or array");
                    for (d.sort = [], b = 0, c = e.length; c > b; b++)if (i(e[b]))d.sort.push(e[b]); else {
                        if (!u(e[b]))throw new TypeError("Invalid object in array");
                        d.sort.push(e[b]._self())
                    }
                }
            } else if (2 === arguments.length) {
                var f = arguments[0], h = arguments[1];
                if (i(f) && i(h) && (h = h.toLowerCase(), "asc" === h || "desc" === h)) {
                    var j = {};
                    j[f] = {order: h}, d.sort.push(j)
                }
            }
            return this
        }, trackScores: function (a) {
            return null == a ? d.track_scores : (d.track_scores = a, this)
        }, size: function (a) {
            return null == a ? d.size : (d.size = a, this)
        }, timeout: function (a) {
            ...
            return null == a ? h.search_type : (a = a.toLowerCase(), ("dfs_query_then_fetch" === a || "dfs_query_and_fetch" === a || "query_then_fetch" === a || "query_and_fetch" === a || "scan" === a || "count" === a) && (h.search_type = a), this)
        }, fields: function (a) {
            if (null == a)return d.fields;
            if (null == d.fields && (d.fields = []), i(a))d.fields.push(a); else {
                if (!g(a))throw new TypeError("Argument must be string or array");
                d.fields = a
            }
            return this
        }, rescore: function (a) {
            if (null == a)return d.rescore;
            if (!n(a))throw new TypeError("Argument must be a Rescore");
            return d.rescore = a._self(), this
        }, from: function (a) {
            return null == a ? d.from : (d.from = a, this)
        }, query: function (a) {
            if (null == a)return d.query;
            if (!m(a))throw new TypeError("Argument must be a Query");
            return d.query = a._self(), this
        }, indices: function (a) {
            if (null == a)return e;
            if (i(a))e = [a]; else {
                if (!g(a))throw new TypeError("Argument must be a string or array");
            ...
            return 0 === e.length && f.length > 0 && (e = ["_all"]), this
        }, types: function (a) {
            if (null == a)return f;
            if (i(a))f = [a]; else {
                if (!g(a))throw new TypeError("Argument must be a string or array");
            ...
            if (null == a)return d.facets;
            if (null == d.facets && (d.facets = {}), !p(a))throw new TypeError("Argument must be a Facet");
            return c(d.facets, a._self()), this
        }, filter: function (a) {
            if (null == a)return d.filter;
            if (!o(a))throw new TypeError("Argument must be a Filter");
            return d.filter = a._self(), this
        }, highlight: function (a) {
            if (null == a)return d.highlight;
            if (!v(a))throw new TypeError("Argument must be a Highlight object");
            return d.highlight = a._self(), this
        }, suggest: function (a) {
            if (null == a)return d.suggest;
            if (null == d.suggest && (d.suggest = {}), i(a))d.suggest.text = a; else {
                if (!w(a))throw new TypeError("Argument must be a string or Suggest object");
                c(d.suggest, a._self())
            }
            return this
        }, scriptField: function (a) {
            if (null == a)return d.script_fields;
            if (null == d.script_fields && (d.script_fields = {}), !q(a))throw new TypeError("Argument must be a ScriptField");
            return c(d.script_fields, a._self()), this
        }, preference: function (a) {
            return null == a ? h.preference : (h.preference = a, this)
        }, local: function (a) {
            return null == a ? h.local : (h.local = a, this)
        }, ignoreIndices: function (a) {
            return null == a ? h.ignore_indices : (a = a.toLowerCase(), ("none" === a || "missing" === a) && (h.ignore_indices = a), this)
        }, indexBoost: function (a, b) {
            return null == d.indices_boost && (d.indices_boost = {}), 0 === arguments.length ? d.indices_boost : (d.indices_boost[a] = b, this)
        }, explain: function (a) {
            return null == a ? d.explain : (d.explain = a, this)
        }, version: function (a) {
            return null == a ? d.version : (d.version = a, this)
        }, minScore: function (a) {
            return null == a ? d.min_score : (d.min_score = a, this)
        }, toString: function () {
            return JSON.stringify(d)
        }, _type: function () {
            return"request"
            ...
            var c = JSON.stringify(d.query);
            if (null == E.client)throw new Error("No Client Set");
            return E.client.del(j("_query"), c, a, b)
        }, doCount: function (a, b) {
            var c = JSON.stringify(d.query);
            if (null == E.client)throw new Error("No Client Set");
            return E.client.post(j("_count"), c, a, b)
        }, doSearch: function (a, b) {
            var c = JSON.stringify(d);
            if (null == E.client)throw new Error("No Client Set");
            return E.client.post(j("_search"), c, a, b)
        }, doSearchShards: function (a, b) {
            if (null == E.client)throw new Error("No Client Set");
            return E.client.post(j("_search_shards"), "", a, b)
        }}
    }, E.Rescore = function (a, b) {
        if (null != a && !j(a))throw new TypeError("Argument must be a Number");
        if (null != b && !m(b))throw new TypeError("Argument must be a Query");
        var c = {query: {}};
        return null != a && (c.window_size = a), null != b && (c.query.rescore_query = b._self()), {rescoreQuery: function (a) {
            if (null == a)return c.query.rescore_query;
            if (!m(a))throw new TypeError("Argument must be a Query");
            return c.query.rescore_query = a._self(), this
        }, queryWeight: function (a) {
            if (null == a)return c.query.query_weight;
            if (!j(a))throw new TypeError("Argument must be a Number");
            return c.query.query_weight = a, this
        }, rescoreQueryWeight: function (a) {
            if (null == a)return c.query.rescore_query_weight;
            if (!j(a))throw new TypeError("Argument must be a Number");
            return c.query.rescore_query_weight = a, this
        }, windowSize: function (a) {
            if (null == a)return c.window_size;
            if (!j(a))throw new TypeError("Argument must be a Number");
            return c.window_size = a, this
        }, scoreMode: function (a) {
            return null == a ? c.query.score_mode : (a = a.toLowerCase(), ("total" === a || "min" === a || "max" === a || "multiply" === a || "avg" === a) && (c.query.score_mode = a), this)
        }, toString: function () {
            return JSON.stringify(c)
        }, _type: function () {
            return"rescore"
    ...
    }, E.Shape = function (a, b) {
        var c = {}, d = function (a) {
            var b = !1;
            return("point" === a || "linestring" === a || "polygon" === a || "multipoint" === a || "envelope" === a || "multipolygon" === a || "circle" === a || "multilinestring" === a) && (b = !0), b
        };
        return a = a.toLowerCase(), d(a) && (c.type = a, c.coordinates = b), {type: function (a) {
            ...
            return null == a ? c.radius : (c.radius = a, this)
        }, toString: function () {
            return JSON.stringify(c)
        }, _type: function () {
            return"shape"
    ...
    }, E.DirectGenerator = function () {
        var a = E.DirectSettingsMixin(), b = a._self();
    ...
    }, E.DirectSettingsMixin = function () {
        var a = {};
        ...
        }, prefixLen: function (b) {
            return null == b ? a.prefix_len : (a.prefix_len = b, this)
        }, minWordLen: function (b) {
        ...
        return b[a] = {phrase: {}}, {text: function (c) {
        ...
        }, tokenLimit: function (c) {
            return null == c ? b[a].phrase.token_limit : (b[a].phrase.token_limit = c, this)
            ...
            return 0 === arguments.length ? b[a].phrase.highlight : (b[a].phrase.highlight = {pre_tag: c, post_tag: d}, this)
            ...
            if (x(c))b[a].phrase.direct_generator.push(c._self()); else {
                if (!g(c))throw new TypeError("Argument must be a Generator or array of Generators");
                for (b[a].phrase.direct_generator = [], d = 0, e = c.length; e > d; d++) {
                    if (!x(c[d]))throw new TypeError("Argument must be an array of Generators");
                    b[a].phrase.direct_generator.push(c[d]._self())
                }
            }
            return this
        }, toString: function () {
    ...
    }, E.TermSuggester = function (a) {
        var b = {}, d = E.DirectSettingsMixin();
    ...
    return function (b) {
        ...
        return b !== Object(b) && (b = {server: b}), null == b.server && (b.server = ""), c.client = {server: function (a) {
            return null == a ? b.server : (b.server = a, this)
        }, post: function (c, e, f, g) {
            c = b.server + c;
            var h = {url: c, data: e, method: "POST"};
            return d(a(angular.extend(h, b)), f, g)
        }, get: function (c, e, f, g) {
            c = b.server + c;
            var h = {url: c, params: e, method: "GET"};
            return d(a(angular.extend(h, b)), f, g)
        }, put: function (c, e, f, g) {
            c = b.server + c;
            var h = {url: c, data: e, method: "PUT"};
            return d(a(angular.extend(h, b)), f, g)
        }, del: function (c, e, f, g) {
            c = b.server + c;
            var h = {url: c, data: e, method: "DELETE"};
            return d(a(angular.extend(h, b)), f, g)
        }, head: function (c, d, e, f) {
            c = b.server + c;
            var g = {url: c, params: d, method: "HEAD"};
            return a(angular.extend(g, b)).then(function (a) {
    ...
    var c = {restrict: "AM", controller: ["$scope", "$element", "$attrs", "$interpolate", function (c, d, e, f) {
        var g = function (b, c, d) {
        ...
        }, i = {watcherRemover: void 0, binders: [], group: e.boName, element: d, ran: !1, addBinder: function (a) {
            ...
            var c, d;
            for (c = 0, d = this.binders.length; d > c; c++) {
                var e = this.binders[c];
                if (!this.group || this.group == e.group) {
                    var i = e.scope.$eval(e.interpolate ? f(e.value) : e.value);
                    switch (e.attr) {
                        case"if":
                            a(i) && e.transclude(e.scope.$new(), function (a) {
                                var b = e.element.parent(), c = e.element && e.element[e.element.length - 1], d = b && b[0] || c && c.parentNode, f = c && c.nextSibling || null;
                        ...
                        case"style":
                            ...
                            break;
                        case"src":
                            e.element.attr(e.attr, i), b && e.element.prop("src", i);
                        case"attr":
                            angular.forEach(e.attrs, function (a, b) {
                                var c, d;
                        ...
                        case"id":
                        case"value":
                            e.element.attr(e.attr, i)
                    }
                }
            }
            this.ran = !0, this.binders = []
        }};
        return i
    ...
    {directiveName: "boIf", attribute: "if", transclude: "element", terminal: !0, priority: 1e3},
    ...
    var b = 200;
    return angular.module("pasvaz.bindonce").directive(a.directiveName, function () {
        var c = {priority: a.priority || b, transclude: a.transclude || !1, terminal: a.terminal || !1, require: "^bindonce", compile: function (b, c, d) {
            return function (b, c, e, f) {
                var g = e.boParent;
                if (g && f.group != g) {
                    var h = f.element.parent();
                    f = void 0;
                    for (var i; 9 != h[0].nodeType && h.length;) {
                        if ((i = h.data("$bindonceController")) && i.group == g) {
                            f = i;
                            break
                        }
                        h = h.parent()
                    }
                    if (!f)throw Error("No bindonce controller: " + g)
                }
                f.addBinder({element: c, attr: a.attribute, attrs: e, value: e[a.directiveName], interpolate: a.interpolate, group: g, transclude: d, scope: b})
            }
        }};
        return c
    })
    ...
    function a(b) {
        var c, d, e, j;
        if ("[object String]" === Object.prototype.toString.call(b) || "[object Number]" === Object.prototype.toString.call(b))c = a.parse(b); else {
            if (g(b))throw Error("Unsure how to parse array `" + b + "`, please pass an object or CSS style or try Chromath.rgb, Chromath.hsl, or Chromath.hsv");
            b instanceof a ? c = f({}, b) : h(b) && (c = f({}, b))
        }
        if (!c)throw Error("Could not parse `" + b + "`");
        return isFinite(c.a) || (c.a = 1), "r"in c ? (j = [c.r, c.g, c.b], d = a.rgb2hsl(j), e = a.rgb2hsv(j)) : "h"in c && ("l"in c ? (d = [c.h, c.s, c.l], j = a.hsl2rgb(d), e = a.rgb2hsv(j)) : ("v"in c || "b"in c) && ("b"in c && (c.v = c.b), e = [c.h, c.s, c.v], j = a.hsv2rgb(e), d = a.rgb2hsl(j))), f(this, {r: j[0], g: j[1], b: j[2], h: d[0], sl: d[1], l: d[2], sv: e[1], v: e[2], a: c.a}), this.h = (this.h % 360 + 360) % 360, 1 < this.sl && (this.sl /= 100), 1 < this.sv && (this.sv /= 100), 1 < this.l && (this.l /= 100), this.r = i(parseInt(this.r, 10), 0, 255), this.g = i(parseInt(this.g, 10), 0, 255), this.b = i(parseInt(this.b, 10), 0, 255), this.a = i(this.a, 0, 1), this
    }

    function b(a, b, c, d) {
        var e = a;
        return g(e) && (a = e[0], b = e[1], c = e[2], d = e[3]), h(e) && (a = e.r, b = e.g, c = e.b, d = e.a), [a, b, c, d]
    }

    function c(a, b, c, d) {
        var e = a;
        return g(e) && (a = e[0], b = e[1], c = e[2], d = e[3]), h(e) && (a = e.h, b = e.s, c = e.l || e.v, d = e.a), [a, b, c, d]
    }

    function d(a, c, d) {
        return isFinite(c) || (d = b(a, c, d), a = d[0], c = d[1], d = d[2]), a > 1 && (a /= 255), c > 1 && (c /= 255), d > 1 && (d /= 255), [a, c, d]
    }

    function e(a, b, d) {
        return isFinite(b) || (d = c(a, b, d), a = d[0], b = d[1], d = d[2]), b > 1 && (b /= 100), d > 1 && (d /= 100), [(a % 360 + 360) % 360, b, d]
    }

    function f() {
        for (var a, b, c = arguments[0], d = 1; a = arguments[d++];)for (b in a)c[b] = a[b];
        return c
    }
    ...
    a.rgb = function (c, d, e, f) {
        return f = b(c, d, e, f), c = f[0], d = f[1], e = f[2], f = f[3], new a({r: c, g: d, b: e, a: f})
    }, a.rgba = a.rgb, a.hsl = function (b, d, e, f) {
        return f = c(b, d, e, f), b = f[0], d = f[1], e = f[2], f = f[3], new a({h: b, s: d, l: e, a: f})
    }, a.hsla = a.hsl, a.hsv = function (b, d, e, f) {
        return f = c(b, d, e, f), b = f[0], d = f[1], e = f[2], f = f[3], new a({h: b, s: d, v: e, a: f})
    }, a.hsva = a.hsv, a.hsb = a.hsv, a.hsba = a.hsva, a.toInteger = function (b) {
        return b = new a(b).toRGBObject(), b.b | b.g << 8 | b.r << 16
    }, a.toName = function (b) {
        var c, b = +new a(b);
        for (c in a.colors)if (+a[c] == b)return c
    }, a.rgb2hex = function (b, c, d) {
        for (b = a.toInteger({r: b, g: c, b: d}).toString(16).toUpperCase(), c = 6, d = 0, b = b.toString(), c || (c = 2), d || (d = "0"); b.length < c;)b = d + b;
        return"#" + b
    }, a.rgb2hsl = function (a, b, c) {
        var e, c = d(a, b, c), a = c[0], b = c[1], c = c[2], f = Math.max(a, b, c), g = Math.min(a, b, c), h = f - g, g = .5 * (f + g), i = 0 === h ? 0 : h / (1 - Math.abs(2 * g - 1));
        return 0 === h ? e = 0 : f === a ? e = (b - c) / h % 6 : f === b ? e = (c - a) / h + 2 : f === c && (e = (a - b) / h + 4), [60 * e, parseFloat(i), parseFloat(g)]
    }, a.rgb2hsv = function (a, b, c) {
        var e, c = d(a, b, c), a = c[0], b = c[1], c = c[2], f = Math.max(a, b, c), g = Math.min(a, b, c), g = f - g;
        return 0 === g ? e = 0 : f === a ? e = (b - c) / g % 6 : f === b ? e = (c - a) / g + 2 : f === c && (e = (a - b) / g + 4), [60 * e, parseFloat(0 === g ? 0 : g / f), parseFloat(f)]
    }, a.rgb2hsb = a.rgb2hsv, a.hsl2rgb = function (a, b, c) {
        var c = e(a, b, c), a = c[0], b = c[1], c = c[2], b = (1 - Math.abs(2 * c - 1)) * b, a = a / 60, d = b * (1 - Math.abs(a % 2 - 1));
        switch (Math.floor(a)) {
            case 0:
                a = [b, d, 0];
                break;
        ...
        return[Math.round(this.r), Math.round(this.g), Math.round(this.b), parseFloat(this.a)]
    }, toRGBAObject: function () {
        var a = this.toRGBAArray();
        ...
        return this.toHexString().slice(1).match(/([\dA-F]{2})/gi)
    }, toHexObject: function () {
        var a = this.toHexArray();
        return{r: a[0], g: a[1], b: a[2]}
    }, toHexString: function () {
        return a.rgb2hex(this.r, this.g, this.b)
    }, hsl: function () {
        return this.toHSLArray()
    }, toHSLArray: function () {
        return this.toHSLAArray().slice(0, 3)
    }, toHSLObject: function () {
        var a = this.toHSLArray();
        return{h: a[0], s: a[1], l: a[2]}
    }, toHSLString: function () {
        return"hsl(" + this.toHSLArray().join(",") + ")"
    }, hsla: function () {
        return this.toHSLAArray()
    }, toHSLAArray: function () {
        return[Math.round(this.h), parseFloat(this.sl), parseFloat(this.l), parseFloat(this.a)]
    }, toHSLAObject: function () {
        var a = this.toHSLArray();
        return{h: a[0], s: a[1], l: a[2], a: a[3]}
    }, toHSLAString: function () {
        return"hsla(" + this.toHSLAArray().join(",") + ")"
    }, hsv: function () {
        return this.toHSVArray()
    }, toHSVArray: function () {
        return[Math.round(this.h), parseFloat(this.sv), parseFloat(this.v)]
    }, toHSVObject: function () {
        return{h: Math.round(this.h), s: parseFloat(this.sv), v: parseFloat(this.v)}
    }, toHSVString: function () {
        var a = this.toHSVArray();
        return"hsv(" + [a[0], 100 * a[1] + "%", 100 * a[2] + "%"] + ")"
    }, hsva: function () {
        return this.toHSVAArray()
    }, toHSVAArray: function () {
        return[Math.round(this.h), parseFloat(this.sv), parseFloat(this.v), parseFloat(this.a)]
    }, toHSVAObject: function () {
        var a = this.toHSVAArray();
        return{h: a[0], s: a[1], l: a[2], a: a[3]}
    }, toHSVAString: function () {
        var a = this.toHSVAArray();
        return"hsva(" + [a[0], 100 * a[1] + "%", 100 * a[2] + "%", a[3]] + ")"
    }, hsb: function () {
        return this.hsv()
    }, toHSBArray: function () {
        return this.toHSVArray()
        ...
        return a.complement(this)
    }, triad: function () {
        return a.triad(this)
    }, tetrad: function () {
        return a.tetrad(this)
    }, analogous: function (b, c) {
        return a.analogous(this, b, c)
    }, monochromatic: function (b) {
        return a.monochromatic(this, b)
    }, splitcomplement: function () {
        return a.splitcomplement(this)
    }, tint: function (b) {
        return a.tint(this, b)
    }, lighten: function (a) {
        return this.tint(a)
    }, shade: function (b) {
        return a.shade(this, b)
    }, darken: function (a) {
        return this.shade(a)
    }, desaturate: function (b) {
        return a.desaturate(this, b)
    }, greyscale: function (a) {
        return this.desaturate(a)
    }, websafe: function () {
        return a.websafe(this)
    }, additive: function () {
        var b = Array.prototype.slice.call(arguments);
        return a.additive.apply(a, [this].concat(b))
    }, subtractive: function () {
        var b = Array.prototype.slice.call(arguments);
        return a.subtractive.apply(a, [this].concat(b))
    }, multiply: function () {
        var b = Array.prototype.slice.call(arguments);
        return a.multiply.apply(a, [this].concat(b))
    }, average: function () {
        var b = Array.prototype.slice.call(arguments);
        return a.average.apply(a, [this].concat(b))
    }, overlay: function (b, c) {
        return a.overlay(this, b, c)
    }, clone: function () {
        return new a(this)
    }, towards: function (b, c) {
        return a.towards(this, b, c)
    }, gradient: function (b, c, d) {
        return a.gradient(this, b, c, d)
    }}, f(a, a.colors);
    var k, l, m = "Chromath", n = a;
    "string" != typeof m && (n = m, m = null), k = function () {
        return this
    }.call(null), n = n || {}, "undefined" != typeof module && "undefined" != typeof exports && module.exports && (l = !0, module.exports = exports = n), "undefined" != typeof window && !l && m && n && (k[m] = n)
}(), define("chromath", function () {
}), define("kbn", ["jquery", "underscore", "moment", "chromath"], function (a, b, c) {
    var d = {};
    return d.get_object_fields = function (a) {
        ...
        return b.sort()
    }, d.get_all_fields = function (a, c) {
        return b.uniq(b.without(b.reduce(a, function (a, e) {
            return c ? a.concat(b.keys(d.flatten_json(e._source))) : a.concat(b.keys(e._source))
        }, []), "$$hashkey"))
        ...
        for (var e = c(b), f = 0; f < a.length;) {
            ...
            switch (i = a.charAt(f++)) {
                case"y":
                    0 === g ? d ? e.endOf("year") : e.startOf("year") : 1 === g ? e.add("years", h) : 2 === g && e.subtract("years", h);
                    break;
                case"M":
    ...
    }, d.colorSteps = function (a, c) {
        for (var d = c > 5 ? 1.6 / c : .25, e = [], f = 1; c + 1 > f; f += 1)e.push(f % 2 ? (f - 1) * d * -1 / 2 : f * d / 2);
        return b.map(e.sort(function (a, b) {
            return a - b
        }), function (b) {
            return 0 > b ? Chromath.darken(a, -1 * b).toString() : Chromath.lighten(a, b).toString()
        })
    }, d.smallestMissing = function (a, b, c) {
        if (b = b || 0, c = c || a.length - 1, b > c)return c + 1;
        if (b !== a[b])return b;
        var e = Math.floor((b + c) / 2);
        return a[e] > e ? d.smallestMissing(a, b, e) : d.smallestMissing(a, e + 1, c)
    }, d.byteFormat = function (a, c) {
        var d, e = 0;
        for (b.isUndefined(c) ? c = 2 : 0 === c && (c = void 0); Math.abs(a) >= 1024;)e++, a /= 1024;
        switch (e) {
            case 0:
                d = " B";
                break;
    ...
    }, d.shortFormat = function (a, c) {
        var d, e = 0;
        for (b.isUndefined(c) ? c = 2 : 0 === c && (c = void 0); Math.abs(a) >= 1e3;)e++, a /= 1e3;
        switch (e) {
            case 0:
                d = "";
                break;
...
define("filesaver", function () {
    ...
    h.service("dashboard", ["$routeParams", "$http", "$rootScope", "$injector", "$location", "$timeout", "ejsResource", "timer", "kbnIndex", "alertSrv", function (b, h, i, j, k, l, m, n, o, p) {
        ...
        this.refresh = function () {
            ...
            } else v.current.failover ? (v.indices = [v.current.index.default], r.resolve().then(function () {
                i.$broadcast("refresh")
            })) : p.set("No time filter", "Timestamped indices are configured without a failover. Waiting for time filter.", "info", 5e3); else v.indices = [v.current.index.default], r.resolve().then(function () {
                i.$broadcast("refresh")
            })
        };
        var x = function (a) {
        ...
        this.dash_load = function (a) {
            return n.cancel_all(), a = x(a), "none" === a.index.interval && (v.indices = [a.index.default]), v.current = d.clone(a), l(function () {
                r = j.get("querySrv"), q = j.get("filterSrv"), r.init(), q.init()
            }, 0).then(function () {
                v.refresh()
            }), a.refresh && v.set_interval(a.refresh), v.availablePanels = d.difference(e.panel_names, d.pluck(d.union(v.current.nav, v.current.pulldowns), "type")), !0
        ...
        this.file_load = function (a) {
            return h({url: "app/dashboards/" + a.replace(/\.(?!json)/, "/") + "?" + (new Date).getTime(), method: "GET", transformResponse: function (a) {
                return y(a, b)
            }}).then(function (a) {
            ...
            return h({url: e.elasticsearch + "/" + e.kibana_index + "/" + c + "/" + d + "?" + (new Date).getTime(), method: "GET", transformResponse: function (c) {
            ...
            return h({url: "app/dashboards/" + a.replace(/\.(?!js)/, "/"), method: "GET", transformResponse: function (a) {
    ...
    d.service("fields", ["dashboard", "$rootScope", "$http", "alertSrv", function (a, d, e, f) {
        var g = this;
        this.list = ["_type"], this.mapping = {}, this.fullMapping = {}, d.$watch(function () {
            return a.indices
        }, function (c) {
            if (!b.isUndefined(c) && c.length && a.current.index.warm_fields) {
                var d = b.difference(c, b.keys(g.fullMapping));
                d.length > 0 ? g.map(d).then(function (a) {
                    g.fullMapping = b.extend(g.fullMapping, a), g.list = h(g.fullMapping)
                }) : g.list = h(b.pick(g.fullMapping, c))
            }
        });
        var h = function (a) {
            var c = [];
    ...
    e.service("filterSrv", ["dashboard", "ejsResource", "$rootScope", "$timeout", function (a, e, f, g) {
        ...
        var h = {list: {}, ids: []}, i = e(c.elasticsearch), j = this;
        this.init = function () {
            b.defaults(a.current.services.filter, h), j.list = a.current.services.filter.list, j.ids = a.current.services.filter.ids, b.each(j.list, function (a) {
                j.set(a, a.id, !0)
            })
        }, this.set = function (c, d, e) {
            var h;
            if (b.defaults(c, {mandate: "must", active: !0}), b.isUndefined(d))if (b.isUndefined(c.type))h = !1; else {
                var i = k(), l = {alias: "", id: i, mandate: "must"};
                b.defaults(c, l), j.list[i] = c, j.ids.push(i), h = i
            } else b.isUndefined(j.list[d]) ? h = !1 : (b.extend(j.list[d], c), h = d);
            return f.$$phase || f.$apply(), e !== !0 && g(function () {
                a.refresh()
            }, 0), f.$broadcast("filter"), h
        }, this.remove = function (c, d) {
            var e;
            return b.isUndefined(j.list[c]) ? e = !1 : (delete j.list[c], j.ids = a.current.services.filter.ids = b.without(j.ids, c), e = !0), f.$$phase || f.$apply(), d !== !0 && g(function () {
                a.refresh()
            ...
            var c = i.BoolFilter(), d = !1;
            return b.each(a, function (a) {
                if (j.list[a].active)switch (d = !0, j.list[a].mandate) {
                    case"mustNot":
                        c.mustNot(j.getEjsObj(a));
                        break;
                    case"either":
                        c.should(j.getEjsObj(a));
                        break;
                    default:
                        c.must(j.getEjsObj(a))
                }
            }), d || c.must(i.MatchAllFilter()), c
        }, this.getEjsObj = function (a) {
            return j.toEjsObj(j.list[a])
            ...
            return b.pick(j.list, j.idsByType(a, c))
        }, this.idsByType = function (a, c) {
            var d = c ? {type: a} : {type: a, active: !0};
            return b.pluck(b.where(j.list, d), "id")
        }, this.timeField = function () {
            return b.pluck(j.getByType("time"), "field")
        }, this.timeRange = function (a) {
            var c = b.last(b.where(j.list, {type: "time", active: !0}));
        ...
        var k = function () {
            var c = a.current.services.filter.ids.length;
            if (c > 0) {
                var e = b.clone(a.current.services.filter.ids).sort();
                return d.smallestMissing(e)
            }
            return 0
        };
        j.init()
...
}), define("services/querySrv", ["angular", "underscore", "config", "kbn"], function (a, b, c, d) {
    var e = a.module("kibana.services");
    e.service("querySrv", ["dashboard", "ejsResource", "filterSrv", "$q", function (a, e, f, g) {
        a.current.services.query = a.current.services.query || {}, b.defaults(a.current.services.query, {list: {}, ids: []}), this.colors = ["#7EB26D", "#EAB839", "#6ED0E0", "#EF843C", "#E24D42", "#1F78C1", "#BA43A9", "#705DA0", "#508642", "#CCA300", "#447EBC", "#C15C17", "#890F02", "#0A437C", "#6D1F62", "#584477", "#B7DBAB", "#F4D598", "#70DBED", "#F9BA8F", "#F29191", "#82B5D8", "#E5A8E2", "#AEA2E0", "#629E51", "#E5AC0E", "#64B0C8", "#E0752D", "#BF1B00", "#0A50A1", "#962D82", "#614D93", "#9AC48A", "#F2C96D", "#65C5DB", "#F9934E", "#EA6460", "#5195CE", "#D683CE", "#806EB7", "#3F6833", "#967302", "#2F575E", "#99440A", "#58140C", "#052B51", "#511749", "#3F2B5B", "#E0F9D7", "#FCEACA", "#CFFAFF", "#F9E2D2", "#FCE2DE", "#BADFF4", "#F9D9F9", "#DEDAF7"];
        var h = e(c.elasticsearch), i = [], j = {alias: "", pin: !1, type: "lucene", enable: !0}, k = {lucene: {query: "*"}, regex: {query: ".*"}, topN: {query: "*", field: "_type", size: 5, union: "AND"}};
        this.queryTypes = {lucene: {require: ">=0.17.0", icon: "icon-circle", resolve: function (a) {
            var c = g.defer();
            return c.resolve(b.extend(a, {parent: a.id})), c.promise
        }}, regex: {require: ">=0.90.3", icon: "icon-circle", resolve: function (a) {
            var c = g.defer();
            return c.resolve(b.extend(a, {parent: a.id})), c.promise
        }}, topN: {require: ">=0.90.3", icon: "icon-cog", resolve: function (c) {
            var e = "";
            "AND" === c.union ? e = " AND (" + (c.query || "*") + ")" : "OR" === c.union && (e = " OR (" + (c.query || "*") + ")");
            var g = h.Request().indices(a.indices);
            g = g.facet(h.TermsFacet("query").field(c.field).size(c.size).facetFilter(h.QueryFilter(h.FilteredQuery(h.QueryStringQuery(c.query || "*"), f.getBoolFilter(f.ids))))).size(0);
            var i = g.doSearch();
            return i.then(function (a) {
                var f = d.colorSteps(c.color, a.facets.query.terms.length), g = -1;
                return b.map(a.facets.query.terms, function (a) {
                    return++g, l.defaults({query: c.field + ':"' + d.addslashes("" + a.term) + '"' + e, alias: a.term + (c.alias ? " (" + c.alias + ")" : ""), type: "lucene", color: f[g], parent: c.id})
                })
            })
        }}};
        var l = this;
        this.init = function () {
            l.list = a.current.services.query.list, l.ids = a.current.services.query.ids, b.each(l.list, function (a) {
                a = l.defaults(a)
            }), 0 === l.ids.length && l.set({})
        }, this.set = function (a, c) {
            return b.isUndefined(c) ? (a.id = b.isUndefined(a.id) ? m() : a.id, a.color = a.color || n(a.id), a = l.defaults(a), l.list[a.id] = a, l.ids.push(a.id), a.id) : b.isUndefined(l.list[c]) ? !1 : (b.extend(l.list[c], a), c)
        }, this.defaults = function (a) {
            return b.defaults(a, j), b.defaults(a, k[a.type]), a.color = a.color || n(a.id), a
        }, this.remove = function (c) {
            return b.isUndefined(l.list[c]) ? !1 : (delete l.list[c], l.ids = a.current.services.query.ids = b.without(l.ids, c), !0)
        }, this.toEjsObj = function (a) {
            switch (a.type) {
                case"lucene":
                    return h.QueryStringQuery(a.query || "*");
                case"regex":
                    return h.RegexpQuery("_all", a.query);
                default:
                    return!1
            }
        }, this.getQueryObjs = function (a) {
            return b.isUndefined(a) ? i : b.flatten(b.map(a, function (a) {
                return b.where(i, {parent: a})
            }))
        }, this.idsByMode = function (a) {
            switch (a.mode) {
                case"all":
                    return b.pluck(b.where(l.list, {enable: !0}), "id");
                case"pinned":
                    return b.pluck(b.where(l.list, {pin: !0, enable: !0}), "id");
                case"unpinned":
                    return b.pluck(b.where(l.list, {pin: !1, enable: !0}), "id");
                case"selected":
                    return b.intersection(b.pluck(b.where(l.list, {enable: !0}), "id"), a.ids);
                default:
                    return b.pluck(b.where(l.list, {enable: !0}), "id")
            }
        }, this.resolve = function () {
            return g.all(b.map(l.ids, function (a) {
                return l.queryTypes[l.list[a].type].resolve(b.clone(l.list[a])).then(function (a) {
                    return a
                })
            })).then(function (a) {
                return i = b.flatten(a), b.each(i, function (a, b) {
                    a.id = b
                }), i
            })
        };
        var m = function () {
            var c = a.current.services.query.ids.length;
            if (c > 0) {
                var e = b.clone(a.current.services.query.ids).sort();
                return d.smallestMissing(e)
            }
            return 0
        }, n = function (a) {
            return l.colors[a % l.colors.length]
        };
        l.init()
    }])
    ...
    d.controller("DashCtrl", ["$scope", "$route", "ejsResource", "fields", "dashboard", "alertSrv", "panelMove", "esVersion", function (a, d, e, f, g, h, i, j) {
        ...
        }, a.panel_path = function (a) {
            return a ? "app/panels/" + a.replace(".", "/") : !1
        }, a.edit_path = function (b) {
            var c = a.panel_path(b);
            return c ? c + "/editor.html" : !1
    ...
    c.controller("dashLoader", ["$scope", "$http", "timer", "dashboard", "alertSrv", function (a, c, d, e, f) {
        a.loader = e.current.loader, a.init = function () {
            a.gist_pattern = /(^\d{5,}$)|(^[a-z0-9]{10,}$)|(gist.github.com(\/*.*)\/[a-z0-9]{5,}\/*$)/, a.gist = a.gist || {}, a.elasticsearch = a.elasticsearch || {}
    ...
    a.module("kibana.directives").directive("addPanel", ["$compile", function (b) {
        return{restrict: "A", link: function (d, e) {
            d.$watch("panel.type", function () {
                var f = d.panel.type;
                d.reset_panel(f), c.isUndefined(d.panel.type) || (d.panel.loadingEditor = !0, d.require(["panels/" + d.panel.type.replace(".", "/") + "/module"], function () {
    ...
    a.module("kibana.directives").directive("kibanaPanel", ["$compile", function (a) {
        ...
        return{restrict: "E", link: function (d, e, f) {
            ...
            d.$watch(f.type, function (a) {
                e.addClass("ng-cloak");
                var b = a.replace(".", "/");
                d.require(["jquery", "text!panels/" + b + "/module.html"], function (a, e) {
                    var f = a(e), h = f.filter("ngcontroller, [ng-controller], .ng-controller");
                    h = h.add(f.find("ngcontroller, [ng-controller], .ng-controller")), h.length ? (h.first().prepend(c), d.require(["panels/" + b + "/module"], function () {
                        g(f)
                    })) : g(f)
                })
            })
    ...
    a.module("kibana.directives").directive("kibanaSimplePanel", ["$compile", function (c) {
        ...
        return{restrict: "E", link: function (e, f, g) {
            ...
            function i(a) {
                f.addClass("ng-cloak");
                var b = a.replace(".", "/");
                e.require(["jquery", "text!panels/" + b + "/module.html"], function (a, c) {
                    var f = a(c), g = f.filter("ngcontroller, [ng-controller], .ng-controller");
                    g = g.add(f.find("ngcontroller, [ng-controller], .ng-controller")), g.length ? (g.first().prepend(d), e.require(["panels/" + b + "/module"], function () {
                        h(f)
                    })) : h(f)
                })
            }
...
}), define("app", ["angular", "jquery", "underscore", "require", "elasticjs", "bootstrap", "angular-sanitize", "angular-strap", "angular-dragdrop", "extend-jquery", "bindonce"], function (a, b, c, d) {
    ...
    var h = ["elasticjs.service", "$strap.directives", "ngSanitize", "ngDragDrop", "kibana", "pasvaz.bindonce"];
